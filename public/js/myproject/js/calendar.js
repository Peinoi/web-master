...
function createCalendar(yy, mm, dd) {
  ...
  cap.innerHTML = today.getFullYear() + '년 ' + (today.getMonth() + 1) + '월 ' + dd + '일';
  cap.style = 'text-align:left;  font-weight:bold;';
  document.querySelector('#calendar').appendChild(cap);

  let spaces = today.getDay();
  //  console.l/g('여백' + spaces);
